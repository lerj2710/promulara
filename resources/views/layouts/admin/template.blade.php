...
<head>
    ...
    <link href="{{asset('dist/fonts/fonts.ccs')}}" rel="stylesheet">
</head>
...
<head>
    ...
    <!-- Google Font: Source Sans Pro -->
    <link href="dist/fonts/fonts.ccs" rel="stylesheet">
</head>
<body class="hold-transition sidebar-mini">
<div class="wrapper">
...
<script src="plugins/jquery/jquery.min.js"></script>
<!-- jQuery UI 1.11.4 -->
<script src="dist/js/code.jquery.com/ui/1.12.1/jquery-ui.min.js"></script>
<!-- Resolve conflict in jQuery UI tooltip with Bootstrap tooltip -->
<script>
    $.widget.bridge('uibutton', $.ui.button)
</script>
